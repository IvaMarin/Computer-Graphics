...
//    points3.resize(MAX_CNT_POINTS);
//    points4.resize(MAX_CNT_POINTS);
}
...
//    drawBezierCurve(points3);
//    drawBezierCurve(points4);
...
//    for (unsigned int i = 0; i < cntPoints3; i++) {
//        glBegin(GL_POLYGON);
//            glVertex3f(points3[i].x(), points3[i].y(), points3[i].z());
//            glVertex3f(points3[i].x() + SQUARE_SIZE, points3[i].y(), points3[i].z());
//            glVertex3f(points3[i].x() + SQUARE_SIZE, points3[i].y() - SQUARE_SIZE, points3[i].z());
//            glVertex3f(points3[i].x(), points3[i].y() - SQUARE_SIZE, points3[i].z());
//        glEnd();
//        glBegin(GL_POLYGON);
//            glVertex3f(points3[i].x(), points3[i].y(), points3[i].z());
//            glVertex3f(points3[i].x() + SQUARE_SIZE, points3[i].y(), points3[i].z());
//            glVertex3f(points3[i].x() + SQUARE_SIZE, points3[i].y(), points3[i].z() + SQUARE_SIZE);
//            glVertex3f(points3[i].x(), points3[i].y(), points3[i].z() + SQUARE_SIZE);
//        glEnd();
//        glBegin(GL_POLYGON);
//            glVertex3f(points3[i].x(), points3[i].y(), points3[i].z());
//            glVertex3f(points3[i].x(), points3[i].y() - SQUARE_SIZE, points3[i].z());
//            glVertex3f(points3[i].x(), points3[i].y() - SQUARE_SIZE, points3[i].z() + SQUARE_SIZE);
//            glVertex3f(points3[i].x(), points3[i].y(), points3[i].z() + SQUARE_SIZE);
//        glEnd();
//        glBegin(GL_POLYGON);
//            glVertex3f(points3[i].x() + SQUARE_SIZE, points3[i].y(), points3[i].z());
//            glVertex3f(points3[i].x() + SQUARE_SIZE, points3[i].y() - SQUARE_SIZE, points3[i].z());
//            glVertex3f(points3[i].x() + SQUARE_SIZE, points3[i].y() - SQUARE_SIZE, points3[i].z() + SQUARE_SIZE);
//            glVertex3f(points3[i].x() + SQUARE_SIZE, points3[i].y(), points3[i].z() + SQUARE_SIZE);
//        glEnd();
//        glBegin(GL_POLYGON);
//            glVertex3f(points3[i].x(), points3[i].y(), points3[i].z() + SQUARE_SIZE);
...
//        glEnd();
//    }
//    for (unsigned int i = 0; i < cntPoints4; i++) {
//        glBegin(GL_POLYGON);
//            glVertex3f(points4[i].x(), points4[i].y(), points4[i].z());
//            glVertex3f(points4[i].x() + SQUARE_SIZE, points4[i].y(), points4[i].z());
//            glVertex3f(points4[i].x() + SQUARE_SIZE, points4[i].y() - SQUARE_SIZE, points4[i].z());
//            glVertex3f(points4[i].x(), points4[i].y() - SQUARE_SIZE, points4[i].z());
//        glEnd();
//        glBegin(GL_POLYGON);
//            glVertex3f(points4[i].x(), points4[i].y(), points4[i].z());
//            glVertex3f(points4[i].x() + SQUARE_SIZE, points4[i].y(), points4[i].z());
//            glVertex3f(points4[i].x() + SQUARE_SIZE, points4[i].y(), points4[i].z() + SQUARE_SIZE);
//            glVertex3f(points4[i].x(), points4[i].y(), points4[i].z() + SQUARE_SIZE);
//        glEnd();
//        glBegin(GL_POLYGON);
//            glVertex3f(points4[i].x(), points4[i].y(), points4[i].z());
//            glVertex3f(points4[i].x(), points4[i].y() - SQUARE_SIZE, points4[i].z());
//            glVertex3f(points4[i].x(), points4[i].y() - SQUARE_SIZE, points4[i].z() + SQUARE_SIZE);
//            glVertex3f(points4[i].x(), points4[i].y(), points4[i].z() + SQUARE_SIZE);
//        glEnd();
//        glBegin(GL_POLYGON);
//            glVertex3f(points4[i].x() + SQUARE_SIZE, points4[i].y(), points4[i].z());
//            glVertex3f(points4[i].x() + SQUARE_SIZE, points4[i].y() - SQUARE_SIZE, points4[i].z());
//            glVertex3f(points4[i].x() + SQUARE_SIZE, points4[i].y() - SQUARE_SIZE, points4[i].z() + SQUARE_SIZE);
//            glVertex3f(points4[i].x() + SQUARE_SIZE, points4[i].y(), points4[i].z() + SQUARE_SIZE);
//        glEnd();
//        glBegin(GL_POLYGON);
//            glVertex3f(points4[i].x(), points4[i].y(), points4[i].z() + SQUARE_SIZE);
...
void display::change_scale(float s) {
    scale += s;
}
...
void display::set_angle_x(float angle) {
    angleX = angle;
}

void display::set_angle_y(float angle) {
    angleY = angle;
}

void display::set_angle_z(float angle) {
    angleZ = angle;
}

void display::set_step(float s) {
    step = s;
}

void display::change_points1(float val, unsigned int numPoint, unsigned int cord) {
    if (cord == 0) {
...
void display::change_points2(float val, unsigned int numPoint, unsigned int cord) {
    if (cord == 0) {
...
//void display::change_points3(float val, unsigned int numPoint, unsigned int cord) {
//    if (cord == 0) {
//        points3[numPoint].setX(val);
//    } else if (cord == 1) {
//        points3[numPoint].setY(val);
//    } else if (cord == 2) {
//        points3[numPoint].setZ(val);
//    }
//    if (cntPoints3 < 3) {
//        cntPoints3++;
//    }
...
//void display::change_points4(float val, unsigned int numPoint, unsigned int cord) {
//    if (cord == 0) {
//        points4[numPoint].setX(val);
//    } else if (cord == 1) {
//        points4[numPoint].setY(val);
//    } else if (cord == 2) {
//        points4[numPoint].setZ(val);
//    }
//    if (cntPoints4 < 3) {
//        cntPoints4++;
//    }
